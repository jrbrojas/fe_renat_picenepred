  ...
  return (
    <>
      <div>
        ...
        <table id="planificacion_departamentos" className="w-full border border-collapse border-gray-300">
          <thead>
            <tr className="cabecera-cenepred">
              <th rowSpan={2} className="p-2 border border-gray-300">DEPARTAMENTO</th>
              <th colSpan={7} className="p-2 border border-gray-300">ENTIDADES ASISTIDAS</th>
              
            </tr>
            <tr className="text-center">
              <th className="text-xs border border-gray-300 cabecera-cenepred">PDC</th>
              <th className="text-xs border border-gray-300 cabecera-cenepred">PDLC</th>
          ...
          <tbody>
            {isLoading ? (
              ...
              data?.map((item, index) => (
                <tr key={`${item.dpto}-${index}`} className="hover:bg-gray-200">
                  <td className="p-2 border border-gray-300 order">{item.dpto}</td>
                  <td className="p-2 text-center border border-gray-300">{item.prdc}</td>
                  <td className="p-2 text-center border border-gray-300">{item.pdlc}</td>
                  <td className="p-2 text-center border border-gray-300">{item.pot}</td>
                  <td className="p-2 text-center border border-gray-300">{item.pat}</td>
                  <td className="p-2 text-center border border-gray-300">{item.pdu}</td>
                  <td className="p-2 text-center border border-gray-300">{item.poi}</td>
                  <td className="p-2 text-center border border-gray-300">{item.pei}</td>
          ...
          {!isLoading && data && (
            <tfoot>
              <tr className="font-bold bg-gray-100">
                ...
                <td className="p-2 text-center border border-gray-300">{total_pdlc}</td>
