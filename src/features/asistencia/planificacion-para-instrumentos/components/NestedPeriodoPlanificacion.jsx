  ...
  return (
    <>
      <div>
        ...
        <table id="planificacion_periodos" className="w-full border-collapse border border-gray-300">
          <thead>
            <tr className="cabecera-cenepred">
              <th rowSpan={3} className="border border-gray-300 p-2">PERIODOS</th>
          ...
          <tbody>
            {isLoading ? (
              ...
              data?.map((item, index) => (
                <tr key={`${item.periodo}-${index}`} className="hover:bg-gray-200 text-center">
                  <td className="border border-gray-300 p-2">{item.periodo}</td>
