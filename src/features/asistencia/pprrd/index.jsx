          ...
          <h1 className="text-4xl font-bold"> Dashboard </h1>
                    ...
                    <div className="grid w-full gap-3 pt-2 grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 2xl:grid-cols-[65%_35%] mt-8">
                        ...
                        <div className="w-full border-2 shadow-md stats bg-base-200/100">
                            <div className="pt-6 bg-base-200/50 rounded-xl">
                                <h1 className="mb-4 text-lg font-bold text-center">PPRRD POR DEPARTAMENTO/PROVINCIAS/DISTRITOS</h1>
                                <NestedTable ubigeo={ubigodepartamento} instrumento='PPRRD' />
                            </div>
                        </div>

                    </div>

                    <div className="grid gap-6 pt-8 mt-2 grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 2xl:grid-cols-2">
                        <div className="p-6 border-2 shadow-md rounded-xl">
                            <h1 className="mb-4 text-lg font-bold text-center">ENTIDADES ASISTIDAS - NIVELES DE GOBIERNO</h1>
                            <NestedTableNiveles ubigeo={ubigodepartamento} instrumento='PPRRD' departamento={nombreDep} />
