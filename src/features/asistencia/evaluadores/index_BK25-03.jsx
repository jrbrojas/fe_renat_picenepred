...
import DashboardTableResumenEvar from '../../dashboard/components/DashboardTableResumenEvar'
import TablaEvaluadores from './components/TablaEvaluadores'
    ...
    useEffect(() => {
        ...
        const getResumen = async () =>{
            ...
            try {
                ...
                await axiosClient.get('/resumen_evar')
                    .then((response) => {
            ...
            <div className="flex flex-col gap-3 lg:flex-row">
                <div className="mr-0 basis-3/5 md:mr-2">       
                    <div className="pt-2">
                        ...
                        <h1 className="mb-4 text-lg font-bold text-center">RESUMEN POR PERIODO EVAR</h1>
                        <DashboardTableResumenEvar asistenciasdetalles={resumen} loading={loading}/>
